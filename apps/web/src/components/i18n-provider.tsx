...
const en: Record<string, string> = {
  ...
  'Découvrir la carte': 'Explore the menu', 'Voir les choix surprises': 'See surprise picks', 'Voir toute la carte': 'See the full menu', 'À chacun son moment': 'A moment for everyone',
...
const ar: Record<string, string> = {
  ...
  'Volaille dorée, jus corsé, légumes de nos producteurs.': 'دجاج ذهبي، صلصة غنية وخضروات من منتجينا.', 'Découvrir la carte': 'اكتشف القائمة', 'Voir les choix surprises': 'شاهد الاختيارات المفاجئة', 'Voir toute la carte': 'شاهد القائمة كاملة',
