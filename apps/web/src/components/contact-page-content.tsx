          ...
          <div className="rounded-3xl border border-[#1E3A5F]/12 bg-white p-5 shadow-[0_24px_60px_rgba(30,58,95,0.13)] sm:p-8 lg:p-10">
            {sent ? (
              <div className="flex min-h-[520px] flex-col items-center justify-center text-center" role="status">
                ...
                <button type="button" onClick={() => setSent(false)} className="mt-7 rounded-lg border border-[#1E3A5F]/14 bg-[#FAF6EC] px-5 py-3.5 text-sm font-bold text-[#1E3A5F] outline-none hover:border-[#C6A15B] focus-visible:ring-2 focus-visible:ring-[#C6A15B]">{tr('Écrire un autre message')}</button>
              </div>
            ) : (
              <form onSubmit={(event) => { event.preventDefault(); setSent(true); }}>
                ...
                <div className="mt-6 grid gap-5 sm:grid-cols-2">
                  <label className="block text-sm font-bold text-[#1E3A5F]">{tr('Prénom et nom')} *<input required name="name" autoComplete="name" placeholder={tr('Votre nom')} className="mt-2 h-12 w-full rounded-lg border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 text-sm text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
                  <label className="block text-sm font-bold text-[#1E3A5F]">{tr('E-mail')} *<input required type="email" name="email" autoComplete="email" placeholder="vous@exemple.fr" className="mt-2 h-12 w-full rounded-lg border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 text-sm text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
                </div>

                <label className="mt-5 block text-sm font-bold text-[#1E3A5F]">{tr('Votre message')} *<textarea required name="message" rows={6} placeholder={tr('Racontez-nous ce que vous préparez, nous vous répondrons avec soin.')} className="mt-2 w-full resize-y rounded-xl border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 py-3 text-sm leading-6 text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
