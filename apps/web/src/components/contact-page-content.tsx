            ...
            {sent ? (
              ...
              <form onSubmit={(event) => { event.preventDefault(); setSent(true); }}>
                ...
                <div className="mt-6 grid min-w-0 gap-5 sm:grid-cols-2">
                  <label className="block min-w-0 text-sm font-bold text-[#1E3A5F]">{tr('Prénom et nom')} *<input required name="name" autoComplete="name" placeholder={tr('Votre nom')} className="mt-2 h-12 w-full min-w-0 max-w-full rounded-lg border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 text-sm text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
                  <label className="block min-w-0 text-sm font-bold text-[#1E3A5F]">{tr('E-mail')} *<input required type="email" name="email" autoComplete="email" placeholder="vous@exemple.fr" className="mt-2 h-12 w-full min-w-0 max-w-full rounded-lg border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 text-sm text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
                </div>

                <label className="mt-5 block min-w-0 text-sm font-bold text-[#1E3A5F]">{tr('Votre message')} *<textarea required name="message" rows={6} placeholder={tr('Racontez-nous ce que vous préparez, nous vous répondrons avec soin.')} className="mt-2 w-full min-w-0 max-w-full resize-y rounded-xl border border-[#1E3A5F]/14 bg-[#FAF6EC]/45 px-4 py-3 text-sm leading-6 text-[#241F19] outline-none transition-all placeholder:text-[#241F19]/35 hover:border-[#C6A15B]/60 focus:border-[#C6A15B] focus:ring-2 focus:ring-[#C6A15B]/30" /></label>
